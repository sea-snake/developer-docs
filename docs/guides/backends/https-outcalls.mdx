...
For a complete working project, see the [Motoko send_http_get example](https://github.com/dfinity/examples/tree/master/motoko/send_http_get).
...
For a complete working project, see the [Rust send_http_get example](https://github.com/dfinity/examples/tree/master/rust/send_http_get).
